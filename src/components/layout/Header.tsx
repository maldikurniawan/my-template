...
import { PiCaretDown, PiDiceFour, PiHouseLine, PiLaptop, PiMoon, PiSun, PiTextAlignJustify } from 'react-icons/pi';
                ...
                <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black">
                    <div className="horizontal-logo flex lg:hidden justify-between items-center mr-2">
                        <Link to="/" className="main-logo flex items-center shrink-0">
                            ...
                            <span className="text-2xl ml-1.5 font-semibold align-middle hidden md:inline dark:text-white-light transition-all duration-300">TENSHI</span>
                        </Link>
                        <button
                            type="button"
                    ...
                    <div className="sm:flex-1 sm:ml-0 ml-auto flex items-center justify-end space-x-1.5 lg:space-x-2 main-logo dark:text-[#d0d2d6]">
                            ...
                            {theme === 'light' ? (
                                <button
                                    ...
                                    className={`${theme === 'light' &&
                                        'flex items-center p-2 rounded-full cursor-pointer bg-white-light/40 dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60'
                                        }`}
                                    onClick={() =>
                                        setTheme('dark')
                                    }
                        ...
                        <img src="https://i.pravatar.cc/200" alt="Profile" className='w-9 h-9 rounded-full object-cover saturate-50 hover:saturate-100 cursor-pointer' />
                    </div>
                </div>
                    ...
                    <li className="menu nav-item relative">
                        <button type="button" className="nav-link">
                            <div className="flex items-center">
                                ...
                                <span className="px-1 capitalize">dashboard</span>
                            </div>
                    ...
                    <li className="menu nav-item relative">
                        <button type="button" className="nav-link">
                            <div className="flex items-center">
                                ...
                                <span className="px-1 capitalize">apps</span>
                            </div>
                            <div className="right_arrow">
                                <PiCaretDown />
                            </div>
