            ...
            <div>
                <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black shadow-xs">
                    <div className="horizontal-logo flex lg:hidden justify-between items-center mr-2">
                        <button
                            type="button"
                            className="collapse-icon flex-none dark:text-[#d0d2d6] hover:text-primary dark:hover:text-primary flex lg:hidden p-2 rounded-full bg-white-light/40 dark:bg-dark/40 hover:bg-white-light/90 dark:hover:bg-dark/60 cursor-pointer"
