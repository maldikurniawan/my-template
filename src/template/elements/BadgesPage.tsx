        ...
        >
            ...
            <Card title="Placement">
                <div className="text-sm mb-3">
                    The <span style={{ color: colortheme }}>placement</span> prop is used
            ...
            <Card title="Value">
                <div className="text-sm mb-3">
                    The <span style={{ color: colortheme }}>value</span> prop is used to
                ...
                <div className="flex flex-wrap gap-4">
                    ...
                    <Badge size="xl" value="2" color="info">
